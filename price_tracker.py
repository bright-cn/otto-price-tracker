"""
Otto Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Otto.

Docs  : https://docs.bright.cn/scraping-automation/web-scraper-api/overview
Info  : https://bright.cn/products/insights/price-tracker/otto
"""
...
# Set your Web Scraper ID after building your Otto scraper:
# https://bright.cn/products/web-scraper/otto
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Otto scraper at: https://bright.cn/products/web-scraper/otto\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Otto product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Otto products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Otto category page.

    Example:
        results = discover_by_category("https://otto.de/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.otto.de/product/sample-item-123456",
        # Add more Otto product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "otto_prices.json"
    ...
    # cat_results = discover_by_category("https://otto.de/category/sample", limit=50)
